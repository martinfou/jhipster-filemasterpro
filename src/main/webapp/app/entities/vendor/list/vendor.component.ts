...
import { EntityArrayResponseType, VendorService } from '../service/vendor.service';
...
export class VendorComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.vendors = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IVendor[] | null): IVendor[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.vendorService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
