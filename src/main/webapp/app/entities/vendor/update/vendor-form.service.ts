...
type VendorFormGroupContent = {
  ...
  contactEmail: FormControl<IVendor['contactEmail']>;
  contactPhone: FormControl<IVendor['contactPhone']>;
  address: FormControl<IVendor['address']>;
};
...
export class VendorFormService {
  createVendorFormGroup(vendor: VendorFormGroupInput = { id: null }): VendorFormGroup {
    ...
    return new FormGroup<VendorFormGroupContent>({
      ...
      contactEmail: new FormControl(vendorRawValue.contactEmail),
      contactPhone: new FormControl(vendorRawValue.contactPhone),
      address: new FormControl(vendorRawValue.address),
    });
  }
